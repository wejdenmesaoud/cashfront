...
export const appRoutes: Route[] = [
    ...
    // Landing routes
    {
        ...
        children   : [
            ...
            {path: 'token-debug', loadChildren: () => import('app/modules/auth/token-debug/token-debug.module').then(m => m.TokenDebugModule)}
        ]
    },
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'engineers-list', loadChildren: () => import('app/modules/manager/engineers-list/engineers-list.module').then(m => m.EngineersListModule)},
